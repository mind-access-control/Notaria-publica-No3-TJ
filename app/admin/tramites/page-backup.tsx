...
const tramitesIniciales: TramiteConfig[] = [
  {
    ...
    documentoPreview: {
      ...
      tipo: "testamento",
      descripcion: "Testamento público abierto de María Elena Rodríguez",
    },
  },
  {
    id: "compraventa",
    ...
    documentoPreview: {
      ...
      archivo: "FORMATO-TESTAMENTO-2019.pdf",
      tipo: "escritura",
      descripcion: "Escritura de compraventa de inmueble - Carlos Antonio López",
    },
  },
];
...
export default function ConfiguracionTramites() {
  ...
  const [documentoVistaPrevia, setDocumentoVistaPrevia] = useState<string | null>(null);
  ...
  const handleVistaPrevia = (tramite: TramiteConfig) => {
    if (tramite.documentoPreview) {
      setDocumentoVistaPrevia(tramite.documentoPreview.archivo);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {tramites.map((tramite) => (
            ...
            >
              ...
              <CardContent className="space-y-4">
                {/* Información del Cliente y Expediente */}
                {tramite.cliente && (
                  <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-2 text-xs text-gray-600">
                        ...
                        <span>{tramite.cliente.email}</span>
                      </div>
                      <div className="flex items-center gap-2 text-xs text-gray-600">
                        <Phone className="h-3 w-3" />
                        <span>{tramite.cliente.telefono}</span>
                      </div>
                      {tramite.expediente && (
                        <div className="mt-2 pt-2 border-t border-blue-200">
                          <div className="flex items-center gap-2 text-xs text-blue-700">
                            ...
                            <span>{tramite.expediente.folio}</span>
                          </div>
                          <div className="text-xs text-blue-600 mt-1">
                            Estado: {tramite.expediente.estado}
                          </div>
                        </div>
                      )}
                    </div>
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
                    ...
                    <div className="space-y-1">
                      <div className="text-sm font-semibold text-gray-900">
                        {tramite.documentoPreview.nombre}
                      </div>
                      <div className="text-xs text-gray-600">
                        {tramite.documentoPreview.descripcion}
                      </div>
                      <div className="flex items-center gap-2 mt-2">
                        <Button
                          ...
                          onClick={() => handleVistaPrevia(tramite)}
                        >
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            console.log("Descargar documento:", tramite.documentoPreview?.archivo);
                          }}
                        >
        ...
        <Dialog open={mostrarVistaPrevia} onOpenChange={setMostrarVistaPrevia}>
          <DialogContent className="max-w-6xl max-h-[90vh] w-full h-full p-0">
            <DialogHeader className="p-6 pb-4">
              ...
              <DialogDescription>
                {documentoVistaPrevia && tramites.find(t => t.documentoPreview?.archivo === documentoVistaPrevia)?.documentoPreview?.nombre}
              </DialogDescription>
            </DialogHeader>
            <div className="flex-1 px-6 pb-6">
              <div className="w-full h-[70vh] border border-gray-200 rounded-lg overflow-hidden">
                <iframe
                  src={`/documentos_legales/${encodeURIComponent(documentoVistaPrevia || "")}`}
              ...
              <div className="flex justify-end gap-2 mt-4">
                <Button
                  ...
                  onClick={() => {
                    ...
                    console.log("Descargar documento:", documentoVistaPrevia);
                  }}
                >

            ...
            <>
              ...
              <div className="p-6">
                ...
                <Button
                  ...
                  size="sm"
                  className="w-full bg-white text-slate-800 hover:bg-slate-100 font-bold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5"
                >
